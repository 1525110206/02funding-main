			  ...
			  <div class="panel-body">
				<form role="form" class="form-inline">
				  <div class="form-group">
					...
					<select id="leftToRightList" class="form-control" multiple size="10" style="width:250px;overflow-y:auto;">
				  ...
				  <div class="form-group" style="margin-left:40px;">
					...
					<select id="rightToLeftList"  class="form-control" multiple size="10" style="width:250px;overflow-y:auto;">
	...
	<script type="text/javascript" src="${APP_PATH}/jquery/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#leftToRightBtn").click(function(){
            	var selectedOptions = $("#leftToRightList option:selected");
            	...
            	$.ajax({
            		...
            		success:function(result){
            			...
            			if(result.success){
            				$("#rightToLeftList").append(selectedOptions.clone());
            		...
            		error:function(){
            			layer.msg("分配角色失败", {time:1000, icon:5, shift:6});
            		}
            	});
            ...
            $("#rightToLeftBtn").click(function(){
            	var selectedOptions = $("#rightToLeftList option:selected");
            	...
            	var jsonObj = {
                	...
                	$.ajax({
                		...
                		success:function(result){
                			layer.close(loadingIndex);
                			if(result.success){
                				$("#leftToRightList").append(selectedOptions.clone());
                            	selectedOptions.remove();
