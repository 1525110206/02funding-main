            	...
            	$.ajax({
            		...
            		success:function(result){
						...
						var content = "";
						    ...
						    content +='        	<td> ';
						    content +=' 	      <button type="button" class="btn btn-success btn-xs" onclick="window.location.href=\'${APP_PATH}/role/assignPermission.htm?roleid='+n.id+'\'"><i class=" glyphicon glyphicon-check"></i></button> '; 
