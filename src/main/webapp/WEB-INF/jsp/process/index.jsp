	...
	<script type="text/javascript" src="${APP_PATH}/script/menu.js"></script>
        <script type="text/javascript">
            ...
            $("#uploadPrcDefBtn").click(function(){//click()函数增加回调函数这个参数，表示绑定事件
            	$("#processDefFile").click();//click()的函数没有参数，表示触发单击事件
            });
            		...
            		success:function(result){
						...
						var content = "";
							$.each(data, function(i, n ){
								...
								content+='   <td>'+ n.key +'</td>';
								content+='   <td>';
								content+='         <button type="button" onclick="window.location.href=\'${APP_PATH}/process/showing.do?id='+n.id+'\'" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-eye-open"></i></button>';
